...
class _$_CreatePostState extends _CreatePostState {
  ...
  @override
  String toString() {
    return 'CreatePostState(title: $title, content: $content, userPicture: $userPicture, username: $username, createdAt: $createdAt, code: $code, codeResult: $codeResult, parentId: $parentId, failureOrSuccessOption: $failureOrSuccessOption, contentType: $contentType, language: $language, isLoading: $isLoading, isCompiling: $isCompiling)';
  }
