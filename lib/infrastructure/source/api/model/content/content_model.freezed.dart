...
class _$_ApiContentModel implements _ApiContentModel {
  ...
  @override
  String toString() {
    return 'ApiContentModel(id: $id, content: $content, creatorId: $creatorId, username: $username, title: $title, code: $code, codeResult: $codeResult, creator: $creator, userImage: $userImage, createdAt: $createdAt, parentId: $parentId, contentType: $contentType, numberOfLikes: $numberOfLikes, numberOfDislikes: $numberOfDislikes, numberOfComments: $numberOfComments, stdin: $stdin, stdout: $stdout)';
  }
