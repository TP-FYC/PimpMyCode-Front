...
class _$_ApiNotificationModel implements _ApiNotificationModel {
  ...
  @override
  String toString() {
    return 'ApiNotificationModel(id: $id, dateHour: $dateHour, isSeen: $isSeen, notificationType: $notificationType, contentLinked: $contentLinked, userRecipient: $userRecipient, userLinked: $userLinked)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.contentLinked, contentLinked) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(contentLinked),
